...
type
  ...
  public
    constructor Create(AOwner: TDelphiParseTree; const AName: string; AEntity: TModelEntity;
      IsImportant: Boolean = False);
    destructor Destroy; override;
    ...
    function Add(const NewCode: string; NewEntity: TModelEntity; IsImportant: Boolean = False): TDelphiParseTree; overload;
    procedure Insert(index: Integer; const NewCode: string; NewEntity: TModelEntity); overload;
...
function TDelphiParseTree.Add(const NewCode: string; NewEntity: TModelEntity; IsImportant: Boolean): TDelphiParseTree;
begin
  Result := TDelphiParseTree.Create(nil, NewCode, NewEntity, IsImportant);
  inherited Add(Result);
end;

constructor TDelphiParseTree.Create(AOwner: TDelphiParseTree; const AName: string; AEntity: TModelEntity;
  IsImportant: Boolean);
begin
...
procedure TDelphiParseTree.Insert(index: Integer; const NewCode: string; NewEntity: TModelEntity);
begin
  inherited Insert(index, TDelphiParseTree.Create(Self, NewCode, NewEntity));
end;

procedure TDelphiParseTree.SaveToFile(const Name: string);
var
  sl: TStringList;
