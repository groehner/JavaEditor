...
uses
  ...
  ExtCtrls, Contnrs, SpTBXItem, UUtils, UConnection;
...
begin
  ...
  begin
    ...
    begin
      var aManagedObject := TManagedObject(FManagedObjects[i]);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Handle_Shadow := Max(HANDLESIZE - FConfiguration.ShadowWidth, 0);
  ...
  if assigned(FManagedObjects) then
    ...
    begin
      ...
      begin
        ...
        aCanvas.Brush.Color := FConfiguration.CommentColor;
