...
{$ENDIF}
  ...
  SUserRejectedAccess = 'Cannot perform operation. User rejected access to (%s)';
  SNotificationCenterCannotPerformOperation = 'Cannot perform operation. You have to request permission by using (%s) method.';
  SNotificationCenterFeatureIsNotSupported = 'NotificationCenter doesn''t support (%s) feature.';
