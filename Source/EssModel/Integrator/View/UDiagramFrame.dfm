object AFrameDiagram: TAFrameDiagram
  ...
  object PopMenuClass: TSpTBXPopupMenu
    ...
    object MIClassPopupCompileJava: TSpTBXItem
      Tag = 1
      Caption = 'Compile'
      ImageIndex = 11
      ImageName = 'Compile'
      OnClick = MIClassPopupCompileJavaClick
    end
    ...
    object MIClassPopupInterfaceEdit: TSpTBXItem
      Tag = 1
    ...
    object MIClassPopupDisplay: TSpTBXSubmenuItem
      ...
      object MIClassPopupDisplay4: TSpTBXItem
        Caption = 'all'
        OnClick = MIClassPopupDisplayClick
      end
    end
    ...
    object MIClassPopupDelete: TSpTBXItem
      Tag = 1
      Caption = 'Delete class/interface'
      ImageIndex = 20
      ImageName = 'Delete'
  ...
  object PopMenuObject: TSpTBXPopupMenu
    ...
    object MIObjectPopupOpenClass: TSpTBXItem
      Tag = 1
      Caption = 'Open class'
      ImageIndex = 17
      ImageName = 'ClassOpen'
      OnClick = MIObjectPopupOpenClassClick
    end
    ...
    object MIObjectPopupDisplay: TSpTBXSubmenuItem
      ...
      object MIObjectPopupDisplay4: TSpTBXItem
        Caption = 'all'
        OnClick = MIObjectPopupDisplayClick
      end
    end
  ...
  object PopMenuConnection: TSpTBXPopupMenu
    ...
    OnPopup = PopMenuConnectionPopup
    Left = 32
    Top = 136
    object MIConnectionAssoziation: TSpTBXItem
      Caption = 'Association undirected'
      ImageIndex = 0
      ImageName = 'AssociationUndirected'
      OnClick = MIConnectionClick
    end
    object MIConnectionAssoziationArrow: TSpTBXItem
      Tag = 1
    ...
    object MIConnectionAssoziationBidirectional: TSpTBXItem
      Tag = 2
    ...
    object MIConnectionRecursiv: TSpTBXSubmenuItem
      ...
      ImageIndex = 10
      ImageName = 'Recursive'
      object MIConnectionUpperRight: TSpTBXItem
        Tag = 1
        Caption = 'Top right'
        OnClick = MISetRecursiv
      end
      object MIConnectionUpperLeft: TSpTBXItem
        Tag = 2
        Caption = 'Top left'
        OnClick = MISetRecursiv
      end
      object MIConnectionLowerLeft: TSpTBXItem
        Tag = 3
        Caption = 'Bottom left'
        OnClick = MISetRecursiv
      end
      object MIConnectionLowerright: TSpTBXItem
        Tag = 4
  ...
  object PopupMenuWindow: TSpTBXPopupMenu
    ...
    object MIWindowPopupClassInsert: TSpTBXItem
      Caption = 'Insert class'
      ImageIndex = 2
      ImageName = 'Insert'
      OnClick = MIWindowPopupClassInsertClick
    end
    ...
    object MIWindowPopupDisplay: TSpTBXSubmenuItem
      ...
      object MIWindowPopupDisplay4: TSpTBXItem
        Caption = 'all'
        OnClick = MIWindowPopupDisplayClick
      end
    end
